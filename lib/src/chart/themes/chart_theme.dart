  ...
  void initializeChartTheme(ThemeData theme) {
    switch (theme.brightness) {
      ...
      case Brightness.dark:
        {
          axisLabelColor = const Color.fromRGBO(255, 255, 255, 1);
          axisTitleColor = const Color.fromRGBO(255, 255, 255, 1);
          axisLineColor = const Color.fromRGBO(255, 255, 255, 1);
          majorGridLineColor = const Color.fromRGBO(191, 191, 191, 1);
          minorGridLineColor = const Color.fromRGBO(150, 150, 150, 1);
