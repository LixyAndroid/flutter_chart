...
class _TooltipPainter extends CustomPainter {
  ...
  void renderTooltipView(Offset position) {
          ...
          if (series._visible &&
            ...
            series._regionalData.forEach((dynamic regionRect, dynamic values) {
              ...
              if (paddedRegion.contains(position)) {
                ...
                markerColor =
                    regionRect[2] != null ? regionRect[2] : series._seriesColor;
                ...
                if (chart.tooltipBehavior.format != null) {
                  ...
                  chart.tooltipBehavior._painter.getLocation(tooltipPosition);
                } else {
          ...
          final String resultantString = chart.tooltipBehavior.format
              ...
              .replaceAll(
                  ...
                  chart._chartSeries.visibleSeries[pointRegion.seriesIndex]
                      ...
                      'series.name');
          chart.tooltipBehavior._painter.stringValue = resultantString;
          chart.tooltipBehavior._painter.getLocation(location);
        } else {
          chart.tooltipBehavior._painter.stringValue =
  ...
  void getLocation(Offset position) {
    x = position.dx;
    y = position.dy;
  }
  ...
  void renderTooltip(Canvas canvas) {
    ...
    if (x != null &&
      ...
      drawBackground(canvas, rect, nosePointX, nosePointY, borderRadius, isTop,
  ...
  void show(double x, double y) {
    if (tooltip.enable &&
      ...
      tooltip._painter.renderTooltipView(Offset(x, y));
      ValueNotifier<int>(
