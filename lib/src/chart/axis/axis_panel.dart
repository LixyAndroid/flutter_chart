...
class _ChartAxis {
  ...
  void _axisCrossing(ChartAxis axis) {
    if (axis.crossesAt != null) {
      if (axis.associatedAxisName != null) {
        ...
        if (_chartWidget._requireInvertedAxis) {
  ...
  void _getCrossingValues(ChartAxis currentAxis, ChartAxis targetAxis) {
    ...
    if (!value.isNaN) {
      currentAxis._crossValue =
          updateCrossValue(value, targetAxis._visibleRange);
  ...
  num updateCrossValue(num value, dynamic range) {
      ...
      for (axisIndex = 0; axisIndex < axesLength; axisIndex++) {
        ...
        if (axis._crossValue != null) {
          ...
          final num prevAxisOffsetValue =
              getPrevAxisOffset(_leftAxesCount, rect, axisIndex, 'Left');
    ...
    if (_bottomAxesCount.isNotEmpty) {
      ...
      for (axisIndex = 0; axisIndex < axesLength; axisIndex++) {
        ...
        if (axis._crossValue != null) {
          ...
          final num prevAxisOffsetValue =
              getPrevAxisOffset(_bottomAxesCount, rect, axisIndex, 'Bottom');
          axisSize = (prevAxisOffsetValue == null)
              ? rect.top + rect.height
              : _axisPadding +
                  prevAxisOffsetValue +
    ...
    if (_rightAxesCount.isNotEmpty) {
      ...
      for (axisIndex = 0; axisIndex < axesLength; axisIndex++) {
        ...
        if (axis._crossValue != null) {
          ...
          final num prevAxisOffsetValue =
              getPrevAxisOffset(_rightAxesCount, rect, axisIndex, 'Right');
          axisSize = (prevAxisOffsetValue == null)
              ? rect.left + rect.width
              : (prevAxisOffsetValue +
                      (axis.labelPosition == LabelPosition.inside
    ...
    if (_topAxesCount.isNotEmpty) {
      ...
      for (axisIndex = 0; axisIndex < axesLength; axisIndex++) {
        ...
        if (axis._crossValue != null) {
          ...
          final num prevAxisOffsetValue =
              getPrevAxisOffset(_topAxesCount, rect, axisIndex, 'Top');
          axisSize = (prevAxisOffsetValue == null)
              ? rect.top
              : prevAxisOffsetValue -
                  (axis.labelPosition == LabelPosition.inside
