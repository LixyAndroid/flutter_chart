...
class _RenderTemplateState extends State<_RenderTemplate>
  ...
  void templatesMeasureCompleted() {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.template.needMeasure) {
      ...
      SchedulerBinding.instance
          .addPostFrameCallback((_) => templatesMeasureCompleted());
    } else {
      ...
      final bool isCollide = (templateInfo.templateType == 'DataLabel')
          ...
          : false;
      if (!isCollide && isTemplateWithinBounds(templateInfo.clipRect, rect)) {
  ...
  bool isTemplateWithinBounds(Rect bounds, Rect templateRect) {
    return templateRect.left >= bounds.left &&
