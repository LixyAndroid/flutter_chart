      ...
      case LegendIconType.image:
        {
          ...
          void _drawLegendImage(Canvas canvas) {
            final Rect rect = Rect.fromLTWH(location.dx - width,
                location.dy - height, width * 2, height * 2);
            ...
            void _loadImage() async {
              await _init(legendRenderContext.series.markerSettings.imageUrl);
              if (!_drawImage) {
          ...
          if (legendRenderContext.series.markerSettings.imageUrl != null)
