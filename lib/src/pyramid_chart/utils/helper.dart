...
bool isPointInPolygon(List<Offset> polygon, dynamic point) {
  bool p = false;
  num i = -1;
    ...
    if (series.dataLabelSettings.isVisible &&
      ...
      for (int i = 0; i < series._renderPoints.length; i++) {
        ...
        if (point.isVisible) {
          ...
          if (series.dataLabelSettings.labelPosition == LabelPosition.inside) {
...
Color _getPyramidFunnelColor(
  ...
  if (currentPoint.renderPosition == LabelPosition.inside &&
