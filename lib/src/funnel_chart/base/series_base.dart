...
class _FunnelSeries {
  ...
  void _initializeSeriesProperties(_FunnelSeriesBase<dynamic, dynamic> series) {
    ...
    series._triangleSize = Size(
        _percentToValue(series.width, chartAreaRect.width),
        _percentToValue(series.height, chartAreaRect.height));
    series._neckSize = Size(
        _percentToValue(series.neckWidth, chartAreaRect.width),
        _percentToValue(series.neckHeight, chartAreaRect.height));
  ...
  void getPathSegment(String seriesType, _PointInfo<dynamic> point) {
  ...
  void _calculateFunnelPathRegion(num pointIndex) {
    ...
    getPathSegment(currentSeries._seriesType, currentPoint);
  }
